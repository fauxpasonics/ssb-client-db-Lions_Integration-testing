...
UPDATE a
SET a.new_ssbcrmsystemSSIDWinner = CASE WHEN b.sourcesystem = 'Veritix' then CAST(b.AccountID AS nvarchar(100)) ELSE b.[SSID] end, a.new_ssbcrmsystemSSIDWinnerSourceSystem = b.SourceSystem
FROM [dbo].[Account_Custom] a
