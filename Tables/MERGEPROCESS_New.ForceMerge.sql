...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__ForceMerg__Creat__5D95E53A] DEFAULT (getdate()),
[CreatedBy] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Complete] [bit] NULL CONSTRAINT [DF__ForceMerg__Compl__5E8A0973] DEFAULT ((0)),
